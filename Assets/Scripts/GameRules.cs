...
public class GameRules
{
	...
	public float FLAGshieldPool = 500;


	public float ABLYarmorDrainRange = 20;
	public float ABLYarmorDrainDPSEnemy = 9;
	public float ABLYarmorDrainDPSAlly = 4;
	public float ABLYarmorDrainAPS = 1; // How much armor is restored per second, per victim (total APS scales with number of victims)
	public float ABLYarmorDrainAPSBonusMult = 1; // How much armor is restored per second, per victim, per number of victims? (total APS scales with number of victims, squared)
	...
	public float ABLYshieldProjectInactivePPS = 8; // How much shield pool is regenerated per second the shield is inactive
